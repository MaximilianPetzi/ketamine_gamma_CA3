...
#define nrn_init _nrn_init__kdrpr
#define _nrn_initial _nrn_initial__kdrpr
#define nrn_cur _nrn_cur__kdrpr
#define _nrn_current _nrn_current__kdrpr
#define nrn_jacob _nrn_jacob__kdrpr
#define nrn_state _nrn_state__kdrpr
#define _net_receive _net_receive__kdrpr 
#define rates rates__kdrpr 
#define states states__kdrpr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kdrpr", _hoc_setdata,
 "fun2_kdrpr", _hoc_fun2,
 "fun1_kdrpr", _hoc_fun1,
 "fun3_kdrpr", _hoc_fun3,
 "max_kdrpr", _hoc_max,
 "min_kdrpr", _hoc_min,
 "rates_kdrpr", _hoc_rates,
 0, 0
};
#define fun2 fun2_kdrpr
#define fun1 fun1_kdrpr
#define fun3 fun3_kdrpr
#define max max_kdrpr
#define min min_kdrpr
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 kdrpr /home/maximilian/Desktop/work/neymotin/139421-master/kdrpr.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
 _la = fun3 ( _threadargscomma_ _lv , - 24.9 , - 0.016 , - 5.0 ) ;
   _lb = fun1 ( _threadargscomma_ _lv , - 40.0 , 0.25 , - 40.0 ) ;
   ninf = _la / ( _la + _lb ) ;
   taun = 1.0 / ( _la + _lb ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/kdrpr.mod";
static const char* nmodl_file_text = 
