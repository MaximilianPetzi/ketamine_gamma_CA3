...
#define nrn_init _nrn_init__kahppr
#define _nrn_initial _nrn_initial__kahppr
#define nrn_cur _nrn_cur__kahppr
#define _nrn_current _nrn_current__kahppr
#define nrn_jacob _nrn_jacob__kahppr
#define nrn_state _nrn_state__kahppr
#define _net_receive _net_receive__kahppr 
#define rates rates__kahppr 
#define states states__kahppr 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_kahppr", _hoc_setdata,
 "fun3_kahppr", _hoc_fun3,
 "fun2_kahppr", _hoc_fun2,
 "fun1_kahppr", _hoc_fun1,
 "max_kahppr", _hoc_max,
 "min_kahppr", _hoc_min,
 "rates_kahppr", _hoc_rates,
 0, 0
};
#define fun3 fun3_kahppr
#define fun2 fun2_kahppr
#define fun1 fun1_kahppr
#define max max_kahppr
#define min min_kahppr
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kahppr /home/maximilian/Desktop/work/neymotin/139421-master/kahppr.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _la , _lb ;
 _la = 0.01 * min ( _threadargscomma_ cai / 500.0 , 1.0 ) ;
   _lb = 1.0 / 1000.0 ;
   qinf = _la / ( _la + _lb ) ;
   tauq = 1.0 / ( _la + _lb ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/kahppr.mod";
static const char* nmodl_file_text = 
