...
#define nrn_init _nrn_init__IhOlmKop
#define _nrn_initial _nrn_initial__IhOlmKop
#define nrn_cur _nrn_cur__IhOlmKop
#define _nrn_current _nrn_current__IhOlmKop
#define nrn_jacob _nrn_jacob__IhOlmKop
#define nrn_state _nrn_state__IhOlmKop
#define _net_receive _net_receive__IhOlmKop 
#define states states__IhOlmKop 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_IhOlmKop", _hoc_setdata,
 "fun3_IhOlmKop", _hoc_fun3,
 "fun1_IhOlmKop", _hoc_fun1,
 "fun2_IhOlmKop", _hoc_fun2,
 "max_IhOlmKop", _hoc_max,
 "min_IhOlmKop", _hoc_min,
 "qtau_IhOlmKop", _hoc_qtau,
 "qinf_IhOlmKop", _hoc_qinf,
 0, 0
};
#define fun3 fun3_IhOlmKop
#define fun1 fun1_IhOlmKop
#define fun2 fun2_IhOlmKop
#define max max_IhOlmKop
#define min min_IhOlmKop
#define qtau qtau_IhOlmKop
#define qinf qinf_IhOlmKop
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 0, "cvodeieq");
 	...
 	ivoc_help("help ?1 IhOlmKop /home/maximilian/Desktop/work/neymotin/139421-master/iholmkop.mod\n");
...
double qinf ( _threadargsprotocomma_ double _lv ) {
   double _lqinf;
 _lqinf = fun2 ( _threadargscomma_ _lv , - 84.0 , 1.0 , 10.2 ) * 1.0 ;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/iholmkop.mod";
static const char* nmodl_file_text = 
