...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "phi_capr", "milli-cm2/liter-milliamp-ms",
 "beta_capr", "/ms",
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 capr /home/maximilian/Desktop/work/neymotin/139421-master/capr.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "rcadecay";
...
/*CVODE*/
 static int _ode_spec1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {int _reset = 0; {
   Dcai = - phi * ica - beta * cai ;
   }
 return _reset;
}
 static int _ode_matsol1 (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) {
 Dcai = Dcai  / (1. - dt*( ( - ( beta )*( 1.0 ) ) )) ;
  return 0;
}
 /*END CVODE*/
 static int state (double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt) { {
    cai = cai + (1. - exp(dt*(( - ( beta )*( 1.0 ) ))))*(- ( ( - phi )*( ica ) ) / ( ( - ( beta )*( 1.0 ) ) ) - cai) ;
   }
  return 0;
}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/capr.mod";
static const char* nmodl_file_text = 
