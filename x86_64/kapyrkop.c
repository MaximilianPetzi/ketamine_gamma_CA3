...
#define nrn_init _nrn_init__KaPyrKop
#define _nrn_initial _nrn_initial__KaPyrKop
#define nrn_cur _nrn_cur__KaPyrKop
#define _nrn_current _nrn_current__KaPyrKop
#define nrn_jacob _nrn_jacob__KaPyrKop
#define nrn_state _nrn_state__KaPyrKop
#define _net_receive _net_receive__KaPyrKop 
#define rates rates__KaPyrKop 
#define states states__KaPyrKop 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KaPyrKop", _hoc_setdata,
 "fun3_KaPyrKop", _hoc_fun3,
 "fun1_KaPyrKop", _hoc_fun1,
 "fun2_KaPyrKop", _hoc_fun2,
 "min_KaPyrKop", _hoc_min,
 "max_KaPyrKop", _hoc_max,
 "rates_KaPyrKop", _hoc_rates,
 0, 0
};
#define fun3 fun3_KaPyrKop
#define fun1 fun1_KaPyrKop
#define fun2 fun2_KaPyrKop
#define min min_KaPyrKop
#define max max_KaPyrKop
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 KaPyrKop /home/maximilian/Desktop/work/neymotin/139421-master/kapyrkop.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _laa , _lba ;
 _laa = exp ( - 0.038 * ( dk + fun2 ( _threadargscomma_ _lv , - 40.0 , 1.0 , 5.0 ) * 1.0 ) * ( _lv - ek ) ) ;
   _lba = exp ( - 0.038 * ( fk + fun2 ( _threadargscomma_ _lv , - 40.0 , 1.0 , 5.0 ) * 1.0 ) * ( _lv - ek ) ) ;
   ainf = 1.0 / ( 1.0 + _laa ) ;
   atau = max ( _threadargscomma_ 0.1 , ck * _lba / ( 1.0 + _laa ) ) * 1.0 ;
   binf = fun2 ( _threadargscomma_ _lv , - 56.0 , 1.0 , 1.0 / 0.11 ) * 1.0 ;
   btau = max ( _threadargscomma_ 2.0 , 0.26 * ( _lv + 50.0 ) ) * 1.0 ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/kapyrkop.mod";
static const char* nmodl_file_text = 
  ...
  "\n"
  ":::INCLUDE \"aux_fun.inc\"\n"
  ":::realpath /home/maximilian/Desktop/work/neymotin/139421-master/aux_fun.inc\n"
