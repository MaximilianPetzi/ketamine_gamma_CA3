...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 pnt_receive_size[_mechtype] = 5;
 	...
 	ivoc_help("help ?1 FDSExp2Syn /home/maximilian/Desktop/work/neymotin/LTP_neymotin/ltp_template.mod\n");
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 95 in file ltp_template.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/LTP_neymotin/ltp_template.mod";
static const char* nmodl_file_text = 
  "COMMENT\n"
