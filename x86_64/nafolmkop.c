...
#define nrn_init _nrn_init__NafOlmKop
#define _nrn_initial _nrn_initial__NafOlmKop
#define nrn_cur _nrn_cur__NafOlmKop
#define _nrn_current _nrn_current__NafOlmKop
#define nrn_jacob _nrn_jacob__NafOlmKop
#define nrn_state _nrn_state__NafOlmKop
#define _net_receive _net_receive__NafOlmKop 
#define rates rates__NafOlmKop 
#define states states__NafOlmKop 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_NafOlmKop", _hoc_setdata,
 "fun2_NafOlmKop", _hoc_fun2,
 "fun1_NafOlmKop", _hoc_fun1,
 "fun3_NafOlmKop", _hoc_fun3,
 "max_NafOlmKop", _hoc_max,
 "min_NafOlmKop", _hoc_min,
 "rates_NafOlmKop", _hoc_rates,
 0, 0
};
#define fun2 fun2_NafOlmKop
#define fun1 fun1_NafOlmKop
#define fun3 fun3_NafOlmKop
#define max max_NafOlmKop
#define min min_NafOlmKop
...
#define ena ena_NafOlmKop
 double ena = 90;
#define gna gna_NafOlmKop
 double gna = 30;
 ...
 "gna_NafOlmKop", &gna_NafOlmKop,
 "ena_NafOlmKop", &ena_NafOlmKop,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 NafOlmKop /home/maximilian/Desktop/work/neymotin/139421-master/nafolmkop.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
 ...
 _lam = fun3 ( _threadargscomma_ _lv , - 38.0 , - 0.1 , - 10.0 ) ;
   _lbm = fun1 ( _threadargscomma_ _lv , - 65.0 , 4.0 , - 18.0 ) ;
   minf = _lam / ( _lam + _lbm ) ;
   taom = 1. / ( _lam + _lbm ) ;
   _lah = fun1 ( _threadargscomma_ _lv , - 63.0 , 0.07 , - 20.0 ) ;
   _lbh = fun2 ( _threadargscomma_ _lv , - 33.0 , 1.0 , - 10.0 ) ;
   hinf = _lah / ( _lah + _lbh ) ;
   taoh = 1. / ( _lah + _lbh ) ;
    return 0; }
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ina = ( 1e-3 ) * gna * pow( m , 3.0 ) * h * ( v - ena ) ;
   }
 _current += ina;
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/nafolmkop.mod";
static const char* nmodl_file_text = 
