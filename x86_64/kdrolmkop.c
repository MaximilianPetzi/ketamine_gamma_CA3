...
#define nrn_init _nrn_init__KdrOlmKop
#define _nrn_initial _nrn_initial__KdrOlmKop
#define nrn_cur _nrn_cur__KdrOlmKop
#define _nrn_current _nrn_current__KdrOlmKop
#define nrn_jacob _nrn_jacob__KdrOlmKop
#define nrn_state _nrn_state__KdrOlmKop
#define _net_receive _net_receive__KdrOlmKop 
#define rates rates__KdrOlmKop 
#define states states__KdrOlmKop 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KdrOlmKop", _hoc_setdata,
 "fun2_KdrOlmKop", _hoc_fun2,
 "fun1_KdrOlmKop", _hoc_fun1,
 "fun3_KdrOlmKop", _hoc_fun3,
 "max_KdrOlmKop", _hoc_max,
 "min_KdrOlmKop", _hoc_min,
 "rates_KdrOlmKop", _hoc_rates,
 0, 0
};
#define fun2 fun2_KdrOlmKop
#define fun1 fun1_KdrOlmKop
#define fun3 fun3_KdrOlmKop
#define max max_KdrOlmKop
#define min min_KdrOlmKop
...
#define ek ek_KdrOlmKop
 double ek = -100;
#define gkdr gkdr_KdrOlmKop
 double gkdr = 23;
 ...
 "gkdr_KdrOlmKop", &gkdr_KdrOlmKop,
 "ek_KdrOlmKop", &ek_KdrOlmKop,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 KdrOlmKop /home/maximilian/Desktop/work/neymotin/139421-master/kdrolmkop.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _lan , _lbn ;
 _lan = fun3 ( _threadargscomma_ _lv , 25.0 , - 0.018 , - 25.0 ) ;
   _lbn = fun3 ( _threadargscomma_ _lv , 35.0 , 0.0036 , 12.0 ) ;
   ninf = _lan / ( _lan + _lbn ) ;
   taon = 1. / ( _lan + _lbn ) ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/kdrolmkop.mod";
static const char* nmodl_file_text = 
