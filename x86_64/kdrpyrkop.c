...
#define nrn_init _nrn_init__KdrPyrKop
#define _nrn_initial _nrn_initial__KdrPyrKop
#define nrn_cur _nrn_cur__KdrPyrKop
#define _nrn_current _nrn_current__KdrPyrKop
#define nrn_jacob _nrn_jacob__KdrPyrKop
#define nrn_state _nrn_state__KdrPyrKop
#define _net_receive _net_receive__KdrPyrKop 
#define rates rates__KdrPyrKop 
#define states states__KdrPyrKop 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_KdrPyrKop", _hoc_setdata,
 "fun3_KdrPyrKop", _hoc_fun3,
 "fun2_KdrPyrKop", _hoc_fun2,
 "fun1_KdrPyrKop", _hoc_fun1,
 "min_KdrPyrKop", _hoc_min,
 "max_KdrPyrKop", _hoc_max,
 "rates_KdrPyrKop", _hoc_rates,
 0, 0
};
#define fun3 fun3_KdrPyrKop
#define fun2 fun2_KdrPyrKop
#define fun1 fun1_KdrPyrKop
#define min min_KdrPyrKop
#define max max_KdrPyrKop
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "cvodeieq");
 	...
 	ivoc_help("help ?1 KdrPyrKop /home/maximilian/Desktop/work/neymotin/139421-master/kdrpyrkop.mod\n");
...
static int  rates ( _threadargsprotocomma_ double _lv ) {
   double _lan , _lbn ;
 _lan = exp ( - 0.11 * ( _lv - 13.0 ) ) ;
   _lbn = exp ( - 0.08 * ( _lv - 13.0 ) ) ;
   ninf = 1.0 / ( 1.0 + _lan ) ;
   taon = max ( _threadargscomma_ 2.0 , 50.0 * _lbn / ( 1.0 + _lan ) ) * 1.0 ;
    return 0; }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/maximilian/Desktop/work/neymotin/139421-master/kdrpyrkop.mod";
static const char* nmodl_file_text = 
