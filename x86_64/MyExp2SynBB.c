...
#define e _p[2]
#define f123 _p[3]
#define tau_F123 _p[4]
#define d1123 _p[5]
#define tau_D1123 _p[6]
#define d2123 _p[7]
#define tau_D2123 _p[8]
#define gmax _p[9]
#define Vwt _p[10]
#define i _p[11]
#define g _p[12]
...
#define total123 total123_MyExp2SynBB
 double total123 = 0;
 ...
 "d1123", 0, 1,
 "f123", 0, 1e+09,
 "tau_D2123", 1e-09, 1e+09,
 "tau_D1123", 1e-09, 1e+09,
 "tau_F123", 1e-09, 1e+09,
 "tau2", 1e-09, 1e+09,
 "tau1", 1e-09, 1e+09,
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "total123_MyExp2SynBB", "uS",
 "tau1", "ms",
 "tau2", "ms",
 "e", "mV",
 "f123", "1",
 ...
 "total123_MyExp2SynBB", &total123_MyExp2SynBB,
 0,0
};
...
{    _p = _pnt->_prop->param; _ppvar = _pnt->_prop->dparam;
 ...
 _tsav = t; {
   _args[1] = 1.0 + ( _args[1] - 1.0 ) * exp ( - ( t - _args[4] ) / tau_F123 ) ;
   _args[2] = 1.0 - ( 1.0 - _args[2] ) * exp ( - ( t - _args[4] ) / tau_D1123 ) ;
   _args[3] = 1.0 - ( 1.0 - _args[3] ) * exp ( - ( t - _args[4] ) / tau_D2123 ) ;
   _args[4] = t ;
 ...
 total123 = total123 + _args[0] * _args[1] * _args[2] * _args[3] ;
   _args[1] = _args[1] + f123 ;
   _args[2] = _args[2] * d1123 ;
   _args[3] = _args[3] * d2123 ;
   } }
...
{
 { error =  state();
 if(error){fprintf(stderr,"at line 101 in file MyExp2SynBB.mod:\n	SOLVE state METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 }}}
