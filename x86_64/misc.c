...
#define dassign dassign_ 
#define mymalloc mymalloc_ 
#define nokill nokill_ 
#define pwd pwd_ 
#define spitchar spitchar_ 
#define sleepfor sleepfor_ 
#define sassign sassign_ 
#define unmalloc unmalloc_ 
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 void _misc_reg() {
  ...
  _initlists();
 	...
 	ivoc_help("help ?1 misc /home/maximilian/Desktop/work/neymotin/139421-master/misc.mod\n");
 }
static int _reset;
...
static int  sleepfor (  double _lsec ) {
